...
class testbuttons:
    ...
    def create_widgets(self):
        self.canvas = tk.Canvas(self.root, width=self.canvas_width, height=self.canvas_height, bg="#f0f0f0")
        ...
        self.slider_x1 = 0
        self.slider1 = self.canvas.create_oval(self.slider_x1 + 5, 3, self.slider_x1 + self.slider_diameter, self.slider_diameter, fill="gray")

        self.button1 = tk.Button(self.root, text="Выключено", font=("Arial", 12), width=10, command=self.on_release1)
        self.button1.pack(pady=10)

        self.canvas2 = tk.Canvas(self.root, width=self.canvas_width, height=self.canvas_height, bg="#f0f0f0")
        ...
        self.slider_x2 = 0
        self.slider2 = self.canvas2.create_oval(self.slider_x2 + 5, 3, self.slider_x2 + self.slider_diameter, self.slider_diameter, fill="gray")

        self.button2 = tk.Button(self.root, text="Выключено", font=("Arial", 12), width=10, command=self.on_release2)
    ...
    def on_drag1(self, event):
        ...
        self.canvas.coords(self.slider1, slider_x1 + 5, 3, slider_x1 + self.slider_diameter, self.slider_diameter)
    ...
    def on_drag2(self, event):
        ...
        self.canvas2.coords(self.slider2, slider_x2 + 5, 3, slider_x2 + self.slider_diameter, self.slider_diameter)
